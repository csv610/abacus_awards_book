...
\section{Student objective}
Learn how three graph algorithms answer three concrete questions: which vertices belong to the same component, which edges are bridges, and which directed vertices can reach one another.
...
\section{Student objective}
Learn how a zero--one matrix represents a bipartite matching problem, and why the same number of matchings can be computed by two different methods.
\section{What the code does}
...
\section{Student objective}
Learn how to test monotonicity from a complete truth table and use one counterexample to show that parity is not monotone.
\section{What the code does}
...
\section{Student objective}
Learn the difference between vertex labels and graph structure, and see how relabeling and exhaustive checking are used in a tiny graph-isomorphism example.
\section{What the code does}
...
\section{Student objective}
Learn the classical number-theory reduction behind Shor's algorithm: an even order can reveal nontrivial factors of a composite number.
\section{What the code does}
...
\chapter{Madhu Sudan}
\section{Student objective}
Learn the central idea of list decoding: keep every candidate message that agrees with enough received symbols instead of forcing one guess.
\section{What the code does}
...
\section{Student objective}
Learn how repeated hub and authority updates produce HITS scores, and how a local greedy rule navigates a small grid with a shortcut.
\section{What the code does}
...
\section{Student objective}
Learn how a graph Laplacian represents energy and how conjugate gradient uses matrix--vector products to solve a small linear system.
\section{What the code does}
...
\section{Student objective}
Learn how vector labels can be rounded into a cut with a random hyperplane, and why the angle between two vectors affects the chance of cutting their edge.
\section{What the code does}
...
\section{Student objective}
Learn to recognize the mixed equilibrium of matching pennies, check an epsilon-equilibrium, and follow a small path to its endpoint.
\section{What the code does}
...
\section{Student objective}
Learn how entropy measures uncertainty and how mutual information measures what remains known after noise. The final protocol calculation is explicitly a toy formula.
\section{What the code does}
...
\section{Student objective}
Learn the matrix--tree idea on a triangle: enumerate spanning trees, compute edge frequencies, and verify the total with a Laplacian determinant.
\section{What the code does}
...
\section{Student objective}
Learn how the book's award history can be represented as records, printed as a timeline, and searched by year.
\section{What the code does}
